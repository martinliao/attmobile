...
public class RecurrencePicker extends DialogFragment implements OnItemSelectedListener,
    ...
    private class RecurrenceModel implements Parcelable {
        ...
        static final int END_BY_DATE = 0;
        static final int END_BY_COUNT = 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mEndCount.addTextChangedListener(new minMaxTextWatcher(0, COUNT_DEFAULT, COUNT_MAX) {
            @Override
            void onChange(int v) {
